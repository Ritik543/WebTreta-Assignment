...
export default function Herosection() {
    return (
      <div className="p-4 sm:p-6 md:p-10">
        ...
        <h2 className="text-3xl sm:text-4xl font-semibold mx-auto text-center text-gray-800 dark:text-white mb-6">
          What is MT Auto Clicker?
        </h2>
  
        
        <hr className="my-4 border-t-2 border-gray-300 dark:border-blue-600 w-[95%] sm:w-[88%] mx-auto" />
  

        <p className="text-sm sm:text-md text-gray-600 p-6 sm:p-12 sm:w-[90%] mx-auto">
